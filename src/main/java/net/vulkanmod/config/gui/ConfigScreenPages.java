        ...
        return OptionPage.createBuilder()
                ...
                .group(OptionGroup.createBuilder()
                        .option(Option.<Integer>createBuilder()
                                ...
                                .build())
                        .option(Option.<WindowMode>createBuilder()
                                .name(Component.translatable("vulkanmod.options.windowMode"))
                                .binding(() -> WindowMode.fromValue(config.windowMode),
                                        value -> {
                                ...
                                .controller(opt -> new CyclingController<>(opt, List.of(WindowMode.values())))
                                .translator(value -> Component.translatable(WindowMode.getComponentName(value)))
                                .build())
                        .option(Option.<Integer>createBuilder()
