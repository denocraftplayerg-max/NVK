...
public interface VertexBuilder {
    ...
    class CompressedVertexBuilder implements VertexBuilder {
        ...
        public void vertex(long ptr, float x, float y, float z, int color, float u, float v, int light, int packedNormal) {
            ...
            // Minecraft light format: blockLight in bits 0-7, skyLight in bits 16-23.
            // Pack into 16-bit short: skyLight in high byte, blockLight in low byte.
            final short l = (short) (((light >> 16) & 0xFF) << 8 | (light & 0xFF));
